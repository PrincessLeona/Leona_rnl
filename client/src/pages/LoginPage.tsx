        ...
        <div className="login-card card">
          <div className="card-body">
            ...
            <div className="alert alert-info mb-4">
              <strong>Security Notice:</strong> This is a secure admin portal. Please protect your login credentials and never share them with unauthorized personnel.
            </div>
            ...
            <div className="text-center mt-4">
              <p style={{ fontSize: '0.75rem', color: '#999' }}>
                © 2024 ChicCheckout. All rights reserved.
              </p>
            </div>
          </div>
        </div>
